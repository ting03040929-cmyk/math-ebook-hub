 ...
 * 欄位說明：
 * - id: 唯一識別碼
 * - chapter: 章節名稱（用於分頁/篩選標籤）
 * - unitNumber: 單元編號（如 1-1, 1-2）
 * - title: 單元全名
 * - desc: 概念說明（適合特教生快速理解）
 * - grade: 年級標籤（預設 七年級）
 * - tags: 概念關鍵字標籤
...
window.MATH_UNITS = [
  {
    ...
    ebookUrl: "unit1-1.html?v=3"
  },
  {
    id: "unit-1-2",
    chapter: "第一章 數與數線",
    unitNumber: "1-2",
    title: "正負數的加減運算與數線距離（特教鷹架漸進版）",
    grade: "七年級上學期",
    desc: "全套 5 頁特教關卡：大減小與小減大、同號負負相加、異號正負抵消、負負得正、數線兩點距離。4 階適性褪除鷹架，循序漸進解題。",
    tags: ["正負數加減", "數線距離", "負負得正", "4階鷹架"],
    voiceUrl: "", // 語音建置中
    ebookUrl: "unit1-2.html?v=3"
  },
  {
    id: "quiz-1",
    chapter: "第一章 數與數線",
    unitNumber: "1-隨堂",
    title: "正負數家族與相反量練習題組（生活情境題）",
    grade: "七年級上學期",
